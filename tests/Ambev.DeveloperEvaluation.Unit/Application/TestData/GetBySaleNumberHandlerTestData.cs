...
public static class GetBySaleNumberHandlerTestData
{
    private static readonly Faker<GetBySaleNumberCommand> commandFaker = new Faker<GetBySaleNumberCommand>()
        .RuleFor(c => c.SaleNumber, f => f.Random.AlphaNumeric(10).ToUpper());
    ...
    private static readonly Faker<GetBySaleNumberResult> resultFaker = new Faker<GetBySaleNumberResult>()
    ...
    public static GetBySaleNumberCommand GenerateValidCommand() => commandFaker.Generate();
    public static Sale GenerateValidSale() => saleFaker.Generate();
    public static GetBySaleNumberResult GenerateValidResult() => resultFaker.Generate();
}